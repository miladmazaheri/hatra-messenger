...
{
    public abstract class MessengerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MessengerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MessengerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MessengerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MessengerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MessengerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MessengerDbContext, Task<T>> func)
        {
            T result;
