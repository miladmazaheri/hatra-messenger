...
namespace Hatra.Messenger.Migrations
{
    ...
    [Migration("20210712060611_UpdateSP_GetChatContent_20210712")]
    partial class UpdateSP_GetChatContent_20210712
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hatra.Messenger.Chats.Entities.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hatra.Messenger.Chats.Entities.ChatContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChatId", "CreationTime");
            ...
            modelBuilder.Entity("Hatra.Messenger.Chats.Entities.FcmToken", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Hatra.Messenger.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Hatra.Messenger.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Hatra.Messenger.Chats.Entities.ChatContent", b =>
                {
                    b.HasOne("Hatra.Messenger.Chats.Entities.Chat", "Chat")
                        .WithMany()
